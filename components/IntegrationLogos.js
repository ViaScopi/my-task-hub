// Integration brand logos as React components

export function GitHubLogo({ size = 32, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function GoogleLogo({ size = 32, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrelloLogo({ size = 32, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
